...
public class RegisterControllerTest {
    ...
    public void registerToEvent() throws Exception {
        mvc.perform(post("/register")
                ...
                .param("attendee.firstName", "firstName")
                .param("attendee.lastName", "lastName")
                .param("attendee.company", "companyName")
                .param("attendee.address", "aaa@example.com")
                .param("ticketId", "1")
                .param("eventId", "1"))
        ...
        assertEquals("firstName", all.get(0).getAttendeeFirstName());
        assertEquals("lastName", all.get(0).getAttendeeLastName());
        assertEquals("companyName", all.get(0).getAttendeeCompany());
        assertEquals("aaa@example.com", all.get(0).getAttendeeAddress());
